    ...
    <div class="row">
        <div class="col-12 mb-4">
            ...
            <header class="d-flex justify-content-between align-items-center mb-3">
                ...
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" title="Registrar" data-bs-target="#modalMetodoPago">
            ...
            <section class="card shadow-sm border-0 h-100">
                <div class="card-header bg-white border-bottom-0 pt-4 pb-2 px-4 d-flex justify-content-between align-items-center">
                    ...
                    <div class="input-group" style="max-width: 250px;">
                        ...
                        <input type="text" class="form-control border-start-0 ps-0 text-muted" id="inputBusqueda" placeholder="Buscar método...">
                    </div>
                </div>
