    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <header class="modal-header">
                <h1 class="modal-title fs-5" id="registerModalLabel"><i class="bi bi-rulers"></i> Registrar Nueva Unidad</h1>
            ...
            <form action="?url=unidadmedida" method="POST">
                ...
                <footer class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary"><i class="bi bi-save"></i> Registrar Unidad</button>
                </footer>
            </form>
        </div>
    </div>
