    ...
    <div class="row">
        <div class="col-12 mb-4">
            ...
            <header class="d-flex justify-content-between align-items-center mb-3">
                <h2 class="mb-0 text-primary fw-bold"><i class="bi bi-ev-front me-2"></i> Gestion de Estados</h2>
                <button type="button" class="btn btn-primary" title="Registrar" data-bs-toggle="modal" data-bs-target="#modalEstado">
            ...
            <section class="card shadow-sm border-0 h-100">
                <div class="card-header bg-white border-bottom-0 pt-4 pb-2 px-4 d-flex justify-content-between align-items-center">
                    ...
                    <div class="input-group" style="max-width: 250px;">
                        ...
                        <input type="text" class="form-control border-start-0 ps-0 text-muted" id="inputBusqueda" placeholder="Buscar Estado...">
                    </div>
                </div>
